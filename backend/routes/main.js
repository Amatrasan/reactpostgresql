...
router.post('/select', async (req, res) => {
    ...
    if (!response) {
        return res.json({ result: false, title: 'Получение пользователей.', message: 'Пользователи не найдены' });
    }
    return res.json({ result: true, title: 'Получение пользователей.', message: 'Успешно', return: response });
});
...
router.post('/insert', async (req, res) => {
    try {
        console.log('insert', req.body.data, req.body.tables);
